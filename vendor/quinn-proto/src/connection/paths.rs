...
pub(super) struct PathData {
    ...
    /// Whether GSO should be disabled on this path due to observed burst loss.
    pub(super) disable_segmentation_offload: bool,
...
impl PathData {
    ...
    pub(super) fn from_previous(
        ...
        Self {
            ...
            disable_segmentation_offload: prev.disable_segmentation_offload,
            sending_ecn: true,
            congestion,
            challenge: None,
            challenge_pending: false,
    ...
    pub(super) fn reset(&mut self, now: Instant, config: &TransportConfig) {
        ...
        self.disable_segmentation_offload = false;
...
impl RttEstimator {
    ...
    /// Whether a real RTT sample has been observed.
